...
# - PDF rendering via pypdfium2 (geen Poppler nodig)
# - Multipage PDF support, schaal per pagina
# - Panelen (rechthoeken) + Palen/Buizen (lijnen) met bewerkbare diameter
# - CSV/JSON export en JSON import
# - Compat-patch voor streamlit-drawable-canvas
...
# --- Compat patch: vang naamwijziging image_to_url op in nieuwere Streamlit ---
try:
    from streamlit.elements.image import ImageMixin as _ImageMixin  # type: ignore
...
# --- PDF rendering die op Streamlit Cloud werkt ---
try:
...
st.markdown(
    ...
    **Workflow**
    ...
    2) Zet de **schaal** op de huidige pagina (teken 1 rechte lijn over bekende maat, vul mm in).  
